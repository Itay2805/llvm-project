...
; CHECK: add.f	r1, r2, r2              ; encoding: [0x00,0x05,0x21,0x40]
asl.f r1, r2
; CHECK: asr.f	r1, r2                  ; encoding: [0x00,0x03,0x21,0x18]
asr.f r1, r2
; CHECK: lsr.f	r1, r2                  ; encoding: [0x00,0x05,0x21,0x18]
lsr.f r1, r2
; CHECK: ror.f	r1, r2                  ; encoding: [0x00,0x07,0x21,0x18]
ror.f r1, r2
; CHECK: rrc.f	r1, r2                  ; encoding: [0x00,0x09,0x21,0x18]
rrc.f r1, r2
; CHECK: sexb.f	r1, r2                  ; encoding: [0x00,0x0b,0x21,0x18]
sexb.f r1, r2
; CHECK: extb.f	r1, r2                  ; encoding: [0x00,0x0f,0x21,0x18]
extb.f r1, r2
...
; CHECK: asr.f	r1, 5                   ; encoding: [0x05,0x82,0x3e,0x18]
asr.f r1, 5
; CHECK: lsr.f	r1, 5                   ; encoding: [0x05,0x84,0x3e,0x18]
lsr.f r1, 5
; CHECK: ror.f	r1, 5                   ; encoding: [0x05,0x86,0x3e,0x18]
ror.f r1, 5
; CHECK: rrc.f	r1, 5                   ; encoding: [0x05,0x88,0x3e,0x18]
rrc.f r1, 5
...
; CHECK: asr.eq	r1, r2                  ; encoding: [0x01,0x02,0x21,0x18]
asr.eq r1, r2
; CHECK: lsr.ne	r1, r2                  ; encoding: [0x02,0x04,0x21,0x18]
lsr.ne r1, r2
; ASL .gt: alias for add.gt a, b, b
; CHECK: add.gt	r1, r2, r2              ; encoding: [0x09,0x04,0x21,0x40]
asl.gt r1, r2
; CHECK: sexb.eq	r1, r2                  ; encoding: [0x01,0x0a,0x21,0x18]
sexb.eq r1, r2
