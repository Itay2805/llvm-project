...
; reg, [shimm, shimm] (both must match -- uses limm encoding)
; CHECK: st	r0, [5, 5]              ; encoding: [0x05,0x00,0x1f,0x10,0x05,0x00,0x00,0x00]
st r0, [5, 5]

; shimm, [reg, shimm] (source is shimm -- uses limm for source)
; CHECK: st	5, [r1, 5]              ; encoding: [0x05,0xfc,0x00,0x10,0x05,0x00,0x00,0x00]
st 5, [r1, 5]
